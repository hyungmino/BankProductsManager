...
----------- TBL_PRODUCT 은행별 대출-------------------
-- 우리은행
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '우리은행 첫거래 대출', 10, 3, 3, 20, 5000);
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '우리은행 WON플러스 대출', 17, 3, 5, NULL, 4000);

-- 카카오
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '카카오 첫거래 대출', 11, 3, 3, 20, 4000);
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '카카오 WON플러스 대출', 17, 3, NULL, NULL, 6000);
-- 국민은행
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '국민은행 첫거래 대출', 12, 3, 3, 22, 3000);
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '국민은행 WON플러스 대출', 16, 3, NULL, NULL, 7000);
-- 농협은행
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '농협은행 첫거래 대출', 13, 3, 3, 21, 7000);
INSERT INTO TBL_PRODUCT VALUES (SEQ_PRODUCT_CODE.NEXTVAL, '농협은행 WON플러스 대출', 15, 3, NULL, NULL, 10000);
